...
function addGamesToPage(games) {
    ...
    for (let i = 0; i < games.length; i++){
        ...
        <h2>${games[i].name}</h2>
        <p>Genre: ${games[i].description}</p>
        <p>Platform: ${games[i].backers}</p>`;
...
// let totalUnfundedString = totalUnfunded === 1 ? "game" : "games";
const totalUnfundedString = `A total of $${totalRaised.toLocaleString()} has been raised for ${GAMES_JSON.length} games. Currently,
${totalUnfunded} ${totalUnfunded > 1 ? "games" : "game"} remain unfunded. We need your help to fund these amazing games!`;

// create a new DOM element containing the template string and append it to the description container
const unfundedGamesElement = document.createElement("div");
unfundedGamesElement.innerHTML = totalUnfundedString;
...
// Customization #1: Search Bar  for user to find specific game.
// Function will filter and dsiplay matching games
